    ...
    for file_path in file_paths:
        try:
            ...
            if "Threading: ✅ Detected" in result.stdout:
                ...
                if "WARNING:" in result.stdout or "potential issue" in result.stdout.lower():
...
def main():
    ...
    results = run_mutex_checker(cpp_files[:50], output_file)  # Limit to first 50 files for initial run

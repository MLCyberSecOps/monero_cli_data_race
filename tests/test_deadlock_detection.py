...
class TestDeadlockDetection:
    ...
    def test_detect_potential_deadlock(self, analyzer, temp_cpp_file, cleanup_temp_files):
    ...
    def test_properly_ordered_locks(self, analyzer, temp_cpp_file, cleanup_temp_files):
        ...
        result = analyzer.analyze_file(Path(filepath))
        assert len(result.deadlock_risks) == 0, "Should not detect deadlocks in properly ordered locks"
